...
### Claude Code Status
- [ ] Phase 1: C-OCO-1, C-OCO-2, C-STARTUP, C-WARN, C-INIT, C-SECTOR, C-DD
- [ ] Phase 2: H-PARTIAL, H-TIMEOUT, H-LIQRACE, H-CLAMP, H-CAUTION, H-TZ, H-IDTZ, H-EQCURVE, H-SHORT, H-STALE, H-PRICES, H-PRINT
- [ ] Phase 3: M-CONNECT, M-NANWT, M-GETPOS, M-SIGTERM, M-CANCEL, M-SECTORPASS
- [ ] Tests: T-SHORT, T-OCO-TOPUP, T-ATOMIC, T-LIQFAIL, T-HASDAY, T-FLIP, T-NOPRICE, T-RENORM
